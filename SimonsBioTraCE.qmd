...
- This visualization of all species locality records in Africa curated by the Global Biodiversity Information Facility reveals many dark parts on the map. The record is even patchier when explored over time. One cannot model trajectories without data.
...
This theoretical approach borrows from quantitative genetics and makes competing theories directly comparable on the same data, and allowing us to partition each process's contribution. 
:::
